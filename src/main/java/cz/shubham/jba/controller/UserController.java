package cz.shubham.jba.controller;
...
import cz.shubham.jba.service.BlogService;
import cz.shubham.jba.service.UserService;
...
public class UserController {
	...
	public String doregisterer(@ModelAttribute("user") User user)
{
